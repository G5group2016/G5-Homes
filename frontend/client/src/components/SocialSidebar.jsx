...
const socials = [
    ...
    },
    {
        label: 'LinkedIn',
        color: '#0A66C2',
        href: 'https://linkedin.com/company/g5homes',
    ...
    return (
        <>
            <style>{`
                ...
                .g5-social-item:hover .g5-social-label {
                    max-width: 110px;
                    padding-right: 12px;
                    padding-left: 4px;
                }
                .g5-social-item:hover .g5-social-icon {
                    width: 44px;
                    height: 44px;
                }

                /* Mobile — compact icon strip, no label */
            ...
            <div className="g5-social-sidebar" role="navigation" aria-label="Social media links">
                {socials.map((s, i) => (
                    ...
                    <a
                        ...
                        className="g5-social-item"
                        aria-label={s.label}
                        onMouseEnter={() => setHovered(i)}
                        onMouseLeave={() => setHovered(null)}
                    >
                        <div
                            className="g5-social-icon"
                            style={{ background: s.color }}
                        >
                            {s.svg}
                        </div>
                        <div
                            className="g5-social-label"
                            style={{ background: s.color }}
                        >
                            {s.label}
                        </div>
